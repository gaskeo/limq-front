...
export const langDict: LangStruct = {
    ...
    MaxMessageSizeForm: 'Max message size (KB)',
    NeedBufferizationForm: 'Need bufferization',
    MaxBufferedMessageCount: 'Max buffered message count',
    BufferedDataPersistencyForm: 'Buffered data persistency (hours)',
